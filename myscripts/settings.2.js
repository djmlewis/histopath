...
function setupChangeChapterAutoAtStartup() {
    if (!localStorage.getItem(ls_changeChapterAuto)) localStorage.setItem(ls_changeChapterAuto, "false");
    const cbx = document.getElementById("checkbox-chapterChange");
    cbx.checked = localStorage.getItem(ls_changeChapterAuto) === "true";
    window.changeChapterAuto=localStorage.getItem(ls_changeChapterAuto) === "true";
